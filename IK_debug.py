...
def test_code(test_case):
    ...
    # base_link to link1 TF_Matrix(alpha1, a1, d2, q2)
    ...
    T0_G = T0_1 * T1_2 * T2_3 * T3_4 * T4_5 * T5_6 * T6_G # Transformation Matrix
    # End effector (gripper) position and orientation
...
# Compensate for rotation discrepancy between DH parameters and Gazebo
    ...
    FWK = T0_G.evalf(subs={q1: theta1, q2: theta2, q3: theta3, q4: theta4, q5: theta5, q6: theta6})

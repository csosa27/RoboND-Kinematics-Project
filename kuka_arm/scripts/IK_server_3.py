...
def handle_calculate_IK(req):
	...
	# Create individual transformation matrices
        ...
        T1_2 = TF_Matrix(alpha1, a1, d2, q2).subs(DH) # base_link to link2
        T2_3 = TF_Matrix(alpha2, a2, d3, q3).subs(DH) # base_link to link3
        T3_4 = TF_Matrix(alpha3, a3, d4, q4).subs(DH) # base_link to link4
        T4_5 = TF_Matrix(alpha4, a4, d5, q5).subs(DH) # base_link to link5
        T5_6 = TF_Matrix(alpha5, a5, d6, q6).subs(DH) # base_link to link6
        T6_G = TF_Matrix(alpha6, a6, d7, q7).subs(DH) # base_link to link_gripper
	    ...
	    # Compensate for rotation discrepancy between DH parameters and Gazebo
            Rot_corr = Rot_z.subs(y, rad(180)) * Rot_y.subs(p, rad(-90))
            R_rpy = R_rpy * Rot_corr
